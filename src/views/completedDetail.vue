<template>
    <div class="content">
        <lg-header :leftArrow="true" :titleType="1" title="宿营车段修"></lg-header>
        <van-cell-group
        class="wrapper"
        v-for="item in 1"
        :key="item"
      ...
      <van-steps direction="vertical" :active="4">
        <van-step>
          <h3>添乘干部到位 2016-07-12 12:40</h3>
          <p>添乘干部到位</p>
          <p><van-image width="100" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" /></p>
        </van-step>
        <van-step>
          <h3>作业前3分钟安全教育 2016-07-11 10:00</h3>
          <p>作业前3分钟安全教育</p>
          <p><van-image width="100" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" /></p>
        </van-step>
        <van-step>
          <h3>驻站防护到位 2016-07-10 09:30</h3>
          <p>驻站防护到位</p>
          <p><van-image width="100" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" /></p>
        </van-step>
        <van-step>
            <h3>任务完成 2016-07-10 09:30</h3>
        </van-step>
      </van-steps>
    </div>
</template>
...
<script>
import { Toast, Cell, CellGroup,  Step, Steps, Image } from "vant";
export default{
