<template>
    <div class="content tasking">
        <van-cell-group class="wrapper" :border="true" style="margin-bottom: 10px;">
            ...
            <van-cell v-if="status>=5" title="出网命令号" :value="detailData.sys_code_out"
        ...
        <van-cell-group title='作业地点' :border="true" style="margin-bottom: 10px;">
            <van-cell title="区间（站场）" :value="detailData.task_location" />
            <van-cell title="起止里程" :value="`${detailData.start_destination}至${detailData.end_destination}`" />
        </van-cell-group>
        ...
        <van-cell-group title='其他信息' :border="true" style="margin-bottom: 10px;">
            <van-cell title="职工人数" :value="detailData.peason" />
    ...
    export default {
        ...
        methods: {
            ...
            async getDetailInfo(id) {
                ...
                if (this.detailData.edit_person_json) {
                    ...
                    let detailInfo = this.$route.query.detailInfo
                    this.see_peason = detailInfo.see_peason
                    this.rallway_info = detailInfo.rallway_info
                    this.local_protected = detailInfo.local_protected
                    this.remote_protected = detailInfo.remote_protected
                }
